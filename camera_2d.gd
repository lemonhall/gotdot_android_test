...
@export var follow_node : Control # Node to follow (assign this to your player)

# https://github.com/QuebleGameDev/Godot-Screen-Shake/blob/main/shake_camera/shake_camera.gd
